      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/about"
              className="bg-primary-800 hover:bg-primary-900 text-white font-semibold py-3 px-8 rounded-lg transition-colors inline-flex items-center gap-2 w-full sm:w-auto justify-center border-2 border-white"
            >
              Learn More About Us
            </Link>
          </div>
